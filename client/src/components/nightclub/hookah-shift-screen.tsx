interface HookahShiftScreenProps {
  onBack: () => void;
}

export default function HookahShiftScreen({ onBack }: HookahShiftScreenProps) {
  const menuItems = [
    "КЛАССИЧЕСКИЙ",
    "ГРЕЙПФРУТ",
    "АНАНАС",
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-6">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          <h1 className="text-3xl font-bold tracking-tight uppercase">МЕНЮ</h1>
