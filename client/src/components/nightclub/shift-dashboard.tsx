...
export default function ShiftDashboard({ onGuestsClick }: ShiftDashboardProps) {
  const shiftOpen = true; // Mock shift state
  const selectedRole = { title: "Администратор", slug: "ADMIN" }; // Mock role
