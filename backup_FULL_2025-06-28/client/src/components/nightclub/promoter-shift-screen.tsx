interface PromoterShiftScreenProps {
  onBack: () => void;
  onAddGuests: () => void;
  onCloseShift: () => void;
...
export default function PromoterShiftScreen({ onBack, onAddGuests, onCloseShift, shiftStartTime }: PromoterShiftScreenProps) {
  const buttons = [
    "ДОБАВИТЬ ГОСТЕЙ",
    "СТАТИСТИКА", 
    "ЧАТ",
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-4">
          {buttons.map((buttonText, index) => {
            ...
            const isAddGuests = buttonText === "ДОБАВИТЬ ГОСТЕЙ";
            ...
            return (
              <div key={buttonText} className="relative">
                ...
                <button
                  onClick={isAddGuests ? onAddGuests : isCloseShift ? onCloseShift : undefined}
